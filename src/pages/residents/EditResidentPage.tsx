...
const EditResidentPage: React.FC<{
  ...
  const [resident, setResident] = useState<ResidentDataType | null>(null);
  ...
  useEffect(() => {
    setTitle({
      name: "Formulario para la edición de residentes",
      description:
        "Modifique los datos requeridos para la edición del residente.",
    });
