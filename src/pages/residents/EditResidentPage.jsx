...
export default function CreateResidentPage() {
  ...
  if (resident.length === 0) {
    const getResident = async () => {
      const residentSnap = getDocument("residents", id);
      residentSnap.then((doc) => {
        setResident(doc);
        setEmergencyInputFields(doc.contact.emergency);
      });
    };
    getResident();
  }
  ...
  const submitHandler = (event) => {
    ...
    updateDocument("residents", resident.docId, residentData);
